...
class Tower:
    ...
    def PCR(cls, x: int, y: int):
        """
        a pcr object (1) cd_max: 120 (2) attack range 100, 105, 110, 115, 120, 125 (3) Single attack
        :param x: center x
        :param y: center y
        :return: object
        """
        pcr = cls(x, y, Snipe(), PCR_IMAGE)  # Snipe:the shooting ability(the class named Snipe in attack_strategy.py)
        pcr.cd_max_count = 120               # cool down time
